            ...
            child: Padding(
              ...
              child:  Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton2 <Clinic>(
                        isExpanded: true,
                        hint:  Text('Select Clinic/Hospital ',
                          style: TextStyle(
                  ...
                  SizedBox(height: 10,),
                  hospitalIndex ==  2 ? SizedBox.shrink():timeStot ? Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                                ...
                                children: [
                                  Row(
                                    children: [
                                      ...
                                      Text(" ${widget.doctorDetailsData!.clinic?[hospitalIndex].day}",style: TextStyle(color: AppColors.primary,fontSize: 16),)
                                    ],
                                  )
                                ],
                              ),
